...
echo setlocale(LC_ALL, 'es_RA', 'es_RA.UTF-8');
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            foreach ($menu as $key => $val) {
                ...
                if (substr($key, 0, -1)=="simpl") {
                    ...
                    echo '
                    <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#'.$val[0].'"
                        aria-expanded="true" aria-controls="collapsePages">
                        <i class="'.$val[1].'" aria-hidden="true"></i> 
                        <span>'.$val[0].'</span>
                    </a>
                    <div id="'.$val[0].'" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow align-baseline">
                            ...
                            <span class="nav-link dropdown-toggle text-gray-600 small"><?php echo $diassemana[date('w')]." ".date('d')." de ".$meses[date('n')-1]. " del ".date('Y'). " | ". date('h:i:s A'); ?></span>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Vacunas aplicadas hoy</div>
                                                <?php 
                                                
                                                $dia_ventas=date("Ymd");
                                                $totalm=0;
                                                $sql = "SELECT * FROM movimientos WHERE fecha=$dia_ventas AND estado=0";
                                                $result = $mysqli->query($sql);
                                                if ($result) {
                                                    $rowcount=mysqli_num_rows($result);
                                                   } else {
                                        ...
                                        <div class="col-auto">
                                            <h2><i class="fa fa-list" aria-hidden="true"></i></h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <h2><i class="fa fa-eyedropper" aria-hidden="true"></i></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Última fecha de backup</div>
                                                
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $backup; ?></div>
                                        </div>
                                        <div class="col-auto">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">¿Cierra su sesión?</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">Elija "Salir" para salir.</div>
