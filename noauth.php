...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
           ...
           <!--Llamo al archivo menu.php que contiene la estructura del menu lateral -->
           <?php
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Error</h1>
                    <p class="mb-4">Acceso no autorizado</p>
                    <p><a class="btn btn-info" href="javascript:history.back()">Volver</a></p>
